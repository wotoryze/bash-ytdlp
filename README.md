...
<ul>
  ...
  <li><b>mode</b> - Mode, new - without merging. Default is "new". For example - "new". <b>Optional</b> argument, if you want to skip this argument but not the next ones, replace it with "-".</li>
