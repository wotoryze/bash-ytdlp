...
<ul>
  ...
  <li><b>cookies</b> - Path to text file with browser cookies, this may be needed for yt-dlp, if everything works for you without it, you can leave it out. <b>Optional</b> argument. For example - "./cookies.txt".</li>
</ul>
